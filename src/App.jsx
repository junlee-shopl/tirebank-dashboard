                ...
                <tr className="bg-neutral-100 border-b border-neutral-200">
                  ...
                  {Array.from({ length: DAYS_IN_MONTH }, (_, i) => i + 1).map((day) => (
                    <th
                      ...
                      className="px-1 py-3 text-center text-xs font-semibold text-neutral-500 border-r border-neutral-200 last:border-r-0 cursor-pointer hover:bg-neutral-150 transition-colors min-w-[12px]"
                    >
                      <div>{day}</div>
